package com.suncompass.plateform.kernel.security;

import com.suncompass.plateform.kernel.util.Encodes;
import com.suncompass.plateform.kernel.util.Exceptions;
...
public class Encryption {
	...
	private static final byte[] DEFAULT_KEY = new byte[]{99,-68,94,-19,70,-76,126,-25,0,3,-20,5,108,-28,69,123};
	...
	public static byte[] generateAesKey(int size) {
		return generateKey(AES, size);
	}

	private static byte[] generateKey(String algorithm, int size){
		try {
